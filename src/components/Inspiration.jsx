...
function Inspiration() {
  return (
    <div>
      ...
      <h2 className='font-bold text-xl font-serif mt-4 youth'>Inspiring Journeys:</h2>
      <h2 className='font-bold text-xl font-serif youth'>Physiotherapy Changed Their Lives</h2>
      <p className='mt-2 ambit'>Hear directly from our satisfied patients in these inspiring video testimonials. Watch them share their </p> <p className='ambit'>personal journeys of recovery and transformation through physiotherapy.</p>
      ...
      <div className='video flex justify-center items-center mt-16'>
        ...
        <div className="rightside w-[50vw] hidden sm:block ambit">
            ...
            <p className='font-bold text-[#008A96] text-start mt-6 youth'>truptiben Majethiya</p>
            <p className='text-start ambit'>Condition Cured: severe bilateral plantar fasciitis & Back Pain</p>
        </div>
      </div>
    </div>
  )
